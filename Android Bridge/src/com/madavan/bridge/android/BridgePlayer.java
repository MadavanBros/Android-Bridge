...
public class BridgePlayer extends Thread {
	...
	/**
	 * Reads the entire contents of the InputStream. Note, this method will
	 * return regardless of whether or not there is data to be read.
	 * 
	 * @return message
	 */
	...
	/**
	 * Read the next message from the InputStream. Note, this method will block
	 * until a message is available to be read.
	 * 
	 * @return message
	 */
